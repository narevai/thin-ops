...
<Frame>
<img src="/images/narev-oss/screenshots/gcp-billing-export.png" alt="GCP BigQuery Billing Export" />
</Frame>
...
2. Follow one of these guides to create the FOCUS view:
   ...
   - **FinOps Foundation guide**: [Creating FOCUS Views in BigQuery](/images/narev-oss/guides/gcp-focus-guide-v1.pdf) (comprehensive step-by-step)
...
<Frame>
<img src="/images/narev-oss/screenshots/gcp-create-service-account.png" alt="GCP Service Accounts" />
</Frame>
...
<Frame>
<img src="/images/narev-oss/screenshots/narevai-gcp-provider-dialog.png" alt="NarevAI GCP Provider Dialog" />
</Frame>
