...
**[Connect providers Guide](/narev-oss/connect-providers)**

#### 4. Import billing data

Sync your historical cost data:
**[Sync providers Guide](/narev-oss/getting-started/sync-providers)**

#### 5. Advanced Deployment

For production environments see advanced configuration: [Deployment Guide](/narev-oss/getting-started/deployment)
